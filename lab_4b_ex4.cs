...
{
    public QuadraticEquation(int c) : base(c) {}
    public QuadraticEquation(int b, int c) : base(b, c) { }
...
public class Program
{
    public static void Main()
    {
        ...
        //QuadraticEquation test = new QuadraticEquation(2, 4, 2);

        //foreach (double x in test.Solve())
        //{
        //    Console.WriteLine("My equation: {0}", x);
        //}
    }
}
